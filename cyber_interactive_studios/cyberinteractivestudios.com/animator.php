...
if(isset($_POST['apply']))
{
	...
	if(empty($errors))
	{
		...
		$EMAIL->Subject = 'Contact form submission: Animator';
...
<html>
	<head>
		<title>Animator Application | Cyber Interactive Studios</title>
	...
	<body>
		...
		<div class="content">
			...
			<div class="area" style="padding-top: 150px;">
				...
				?>
			<form id="apply_form" name="animator_form" action="" method="post" enctype="multipart/form-data">
				<label>
				...
				<label>
					Animation Skills: <textarea placeholder="Tell us about your skills" tabindex="5" rows="5" name="user_skills" ></textarea>
				</label>
				<label>
