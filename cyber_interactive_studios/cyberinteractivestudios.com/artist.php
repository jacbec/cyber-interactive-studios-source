...
if(isset($_POST['apply']))
{
	...
	if(empty($errors))
	{
		...
		$EMAIL->Subject = 'Contact form submission: Artist';
...
<html>
	<head>
		<title>2D Artist Application | Cyber Interactive Studios</title>
	...
	<body>
		...
		<div class="content">
			...
			?>
			<form id="apply_form" name="artist_form" action="" method="post" enctype="multipart/form-data">
				<label>
				...
				<label>
					Art Skills: <textarea placeholder="Tell us about your skills" tabindex="5" rows="5" name="user_skills" ></textarea>
				</label>
				<label>
