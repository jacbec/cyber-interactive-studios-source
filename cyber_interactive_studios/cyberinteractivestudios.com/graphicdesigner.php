...
if(isset($_POST['apply']))
{
	...
	if(empty($errors))
	{
		...
		$EMAIL->Host = 'smtp.gmail.comm';
		$EMAIL->Username = 'cyberinteractivestudios@gmail.comm';
		$EMAIL->Password = '*-Cyber_._Studios-*';
		...
		$EMAIL->Subject = 'Contact form submission: Graphic Designer';
...
<html>
	<head>
		<title>3D Graphic Designer Application | Cyber Interactive Studios</title>
	...
	<body>
		...
		<div class="content">
			...
			?>
			<form id="apply_form" name="graphicdesigner_form" action="" method="post" enctype="multipart/form-data">
				<label>
				...
				<label>
					Graphical Skills: <textarea placeholder="Tell us about your skills" tabindex="5" rows="5" name="user_skills" ></textarea>
				</label>
				<label>
