...
if(isset($_POST['apply']))
{
	...
	if(empty($errors))
	{
		...
		$EMAIL->Subject = 'Contact form submission: Programmer';
...
<html>
	<head>
		<title>Programmer Application | Cyber Interactive Studios</title>
	...
	<body>
		...
		<div class="content">
			...
			?>
			<form id="apply_form" name="programmer_form" action="" method="post" enctype="multipart/form-data">
				<label>
				...
				<label>
					Computer Skills: <textarea placeholder="Tell us about your skills" tabindex="5" rows="5" name="user_skills" ></textarea>
				</label>
				<label>
