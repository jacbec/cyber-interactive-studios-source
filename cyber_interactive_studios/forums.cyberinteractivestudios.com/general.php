...
<html>
	<head>
		<title>General Topics | forums.cyberinteractivestudios.comm</title>
...
<?php if(@$_SESSION['user_username']): ?>
	<?php if(isset($_GET['create_topic'])): ?>
				<h2 class="h">Create General Topic</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Create General Topic page. Here you can create general topics about anything and everything.
					</p>
				<?php
					if(!empty($errors))
					{
	...
	<?php else: ?>
				<h2 class="h">General Topics</h2>
					<p class="p" style="text-align: center;">
						Welcome to the General Topics page. Here you can browse and talk about topics that others have posted.
					</p>
				<div class="discussion_forum">
					<div class="discussion_label_top">
						<ul>
							<li class="row_1">General Topics</li>
