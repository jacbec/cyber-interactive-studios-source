...
<html>
	<head>
		<title>Troubleshooting PCs Topics | forums.cyberinteractivestudios.comm</title>
...
<?php if(@$_SESSION['user_username']): ?>
	<?php if(isset($_GET['create_topic'])): ?>
				<h2 class="h">Create Troubleshooting PCs Topic</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Create Troubleshooting PCs Topic page. Here you can create topics about problems you are having with your PC.
					</p>
				<?php
					if(!empty($errors))
					{
	...
	<?php else: ?>
				<h2 class="h">Troubleshooting PCs Topics</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Troubleshooting PCs Topics page. Here you can browse and talk about problems people are having with their PC.
					</p>
				<div class="discussion_forum">
					<div class="discussion_label_top">
						<ul>
							<li class="row_1">Troubleshooting PCs</li>
