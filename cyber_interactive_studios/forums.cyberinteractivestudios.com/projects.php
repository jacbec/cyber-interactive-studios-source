...
<html>
	<head>
		<title>Cyber Interactive Studios Projects Topics | forums.cyberinteractivestudios.comm</title>
...
<?php if(@$_SESSION['user_username']): ?>
	<?php if(isset($_GET['create_topic']) && $_SESSION['is_admin'] == 1): ?>
				<h2 class="h">Cyber Interactive Studios Create Projects Topics</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Cyber Interactive Studios Create Projects Topics page. Here you can create topics about Cyber Interactive Studios Projects for others to read and talk about.
					</p>
				<?php
					if(!empty($errors))
					{
	...
	<?php else: ?>
				<h2 class="h">Cyber Interactive Studios Projects Topics</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Cyber Interactive Studios Projects Topics page. Here you can browse and talk about the projects we have posted.
					</p>
				<div class="discussion_forum">
					<div class="discussion_label_top">
						<ul>
							<li class="row_1">Cyber Interactive Studios Projects</li>
