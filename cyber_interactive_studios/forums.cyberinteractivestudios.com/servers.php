...
<html>
	<head>
		<title>Troubleshooting Servers Topics | forums.cyberinteractivestudios.comm</title>
...
<?php if(@$_SESSION['user_username']): ?>
	<?php if(isset($_GET['create_topic'])): ?>
				<h2 class="h">Create Troubleshooting Servers Topic</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Create Troubleshooting Servers Topic page. Here you can create topics about problems you are having with your sever.
					</p>
				<?php
					if(!empty($errors))
					{
	...
	<?php else: ?>
				<h2 class="h">Troubleshooting Servers Topics</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Troubleshooting Servers Topics page. Here you can browse and talk about problems people are having with their server.
					</p>
				<div class="discussion_forum">
					<div class="discussion_label_top">
						<ul>
							<li class="row_1">Troubleshooting Servers</li>
