...
<html>
	<head>
		<title>Cyber Interactive Studios Updates Topics | forums.cyberinteractivestudios.comm</title>
...
<?php if(@$_SESSION['user_username']): ?>
	<?php if(isset($_GET['create_topic']) && $_SESSION['is_admin'] == 1): ?>
				<h2 class="h">Cyber Interactive Studios Create Updates Topics</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Cyber Interactive Studios Create Updates Topics page. Here you can create topics about updates to Cyber Interactive Studios website or company.
					</p>
				<?php
					if(!empty($errors))
					{
	...
	<?php else: ?>
				<h2 class="h">Cyber Interactive Studios Updates Topics</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Cyber Interactive Studios Updates Topics page. Here you can browse and talk about any update we have made to the website or company.
					</p>
				<div class="discussion_forum">
					<div class="discussion_label_top">
						<ul>
							<li class="row_1">Cyber Interactive Studios Updates</li>
