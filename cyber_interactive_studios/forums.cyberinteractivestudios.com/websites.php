...
<html>
	<head>
		<title>Troubleshooting Websites Topics | forums.cyberinteractivestudios.comm</title>
...
<?php if(@$_SESSION['user_username']): ?>
	<?php if(isset($_GET['create_topic'])): ?>
				<h2 class="h">Create Troubleshooting Websites Topics</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Create Troubleshooting Websites Topic page. Here you can create topics about problems you are having with your website.
					</p>
				<?php
					if(!empty($errors))
					{
	...
	<?php else: ?>
				<h2 class="h">Troubleshooting Websites Topics</h2>
					<p class="p" style="text-align: center;">
						Welcome to the Troubleshooting Websites Topics page. Here you can browse and talk about problems people are having with their website.
					</p>
				<div class="discussion_forum">
					<div class="discussion_label_top">
						<ul>
							<li class="row_1">Troubleshooting Websites</li>
					...
					<div class="discussion_label_bottom">
						<ul><li><a href="?create_topic">Create Topic</a></li></ul> 
					</div>
				</div>
			</div>
	<?php endif; ?>
