...
<html>
	<head>
		<title>store.cyberinteractivestudios.com | Cyber Interactive Studios</title>
			...
			<div class="top_menu">
				<nav>
					<ul style="text-align: right;">
						...
						?>
						<li style="margin-right: 50px;"><a href="index.php">store.cyberinteractivestudios.comm</a></li> 
					</ul>
				</nav>
			</div>
			<!-- Bottom Menu ------------------------------------------------------------------------------------------------>
